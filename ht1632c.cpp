...
inline void ht1632c::_set(uint8_t pin)
{
  pinHI(pin);
}

inline void ht1632c::_toggle(uint8_t pin)
{
  pinTOGGLE(pin);
}

inline void ht1632c::_reset(uint8_t pin)
{
  pinLO(pin);
}

inline void ht1632c::_pulse(uint8_t num, uint8_t pin)
{
  while(num--)
  {
    _set(pin);
